...
function ChatRoom() {
  ...
  // socket receive message update status notify
  useEffect(() => {
    if (messageReadStatus) {
      const { type, readerId, toId: receiveRoomId } = messageReadStatus;
      // Check if the reader is in the conversation
